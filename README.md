...
- Azure AI Search: Basic tier, 1 replica, includes 1,000 free semantic ranker requests per month. Pricing per hour. [Pricing](https://azure.microsoft.com/pricing/details/search/)
